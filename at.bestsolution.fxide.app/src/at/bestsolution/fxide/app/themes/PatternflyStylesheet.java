...
@Component
public class PatternflyStylesheet implements Stylesheet {
	...
	public URL getURL(Theme t) {
		return URLUtils.createUrl("platform:/plugin/at.bestsolution.controls/at/bestsolution/controls/patternfly/css/controls.css");
	}
