...
import at.bestsolution.fxide.jdt.corext.dom.ASTNodes;
import at.bestsolution.fxide.jdt.corext.dom.ASTProvider;
import at.bestsolution.fxide.jdt.corext.javadoc.JavaDocLocations;
import at.bestsolution.fxide.jdt.corext.util.JavaModelUtil;
import at.bestsolution.fxide.jdt.corext.util.JdtFlags;
import at.bestsolution.fxide.jdt.corext.util.Messages;
import at.bestsolution.fxide.jdt.corext.util.MethodOverrideTester;
import at.bestsolution.fxide.jdt.corext.util.SuperTypeHierarchyCache;
import at.bestsolution.fxide.jdt.text.JavaElementLabels;
import at.bestsolution.fxide.jdt.text.viewersupport.JavaElementLinks;
		...
		if (sourceAttachmentPath != null) {
			...
			if (file.isDirectory()) {
				...
				try {
					...
					throw new CoreException(new Status(IStatus.ERROR, "at.bestsolution.fxide.jdt.text", e.getMessage(), e));
				} finally {
					try {
						if (in != null) {
							in.close();
